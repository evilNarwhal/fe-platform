...
import { getMockDashboardCharts, getMockDashboardErrors, getMockDashboardOverview, getMockDashboardRoutes, } from "../modules/dashboard/mock";
import { getDashboardCharts, getDashboardErrors, getDashboardOverview, getDashboardRoutes, } from "../modules/dashboard/service";
...
const parseDashboardQuery = (query) => {
    ...
    const from = typeof query.from === "string" ? new Date(query.from) : new Date(to.getTime() - DAY_MS);
...
const isInvalidQueryError = (error) => error instanceof Error && error.message.startsWith("Invalid query");
/**
